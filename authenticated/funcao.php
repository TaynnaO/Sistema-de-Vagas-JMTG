...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
  <title>Cadastro de Funcao</title>
</head>
<body>
  <main>
  <?php 
  ...
  <form method="post">
    <label for="id_funcao">Selecione a função:</label>
  ...
  if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE admin SET id_funcao = $id_funcao WHERE id = $id_do_usuario";
    if (mysqli_query($conn, $sql)) {
      echo "Função cadastrada com sucesso!";
      header("Location: homeAdmin.php");
      exit(); 
    } else {
      echo "Erro ao cadastrar função: " . mysqli_error($conn);
    }
